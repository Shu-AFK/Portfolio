// TODO: Export and Speed not working
'use client'
...
export default function BeatMakerPro() {
    ...
    const addTrack = (url) => {
        ...
        setTracks(t => [...t, {
            id, name: baseName(url), sampleUrl: url,
            steps: Array(stepsCountRef.current).fill(false),
            params, nodes, loaded: false
        }])
        markLoaded()
    }
    ...
    const exportWav = async () => {
        ...
        const totalSteps = stepsCount * loopCycles
